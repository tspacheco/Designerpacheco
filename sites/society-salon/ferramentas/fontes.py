...
PEDIDOS = sys.argv[1:] or [
  'https://fonts.googleapis.com/css2?family=Oranienbaum&family=Hanken+Grotesk:wght@400;500;600&family=Spline+Sans+Mono:wght@400;500&display=swap',
  'https://fonts.googleapis.com/css2?family=Pirata+One&text=S&display=swap',
]
