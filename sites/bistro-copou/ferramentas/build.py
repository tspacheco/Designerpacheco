#!/usr/bin/env python3
"""Monta index.html (ficheiro único): fontes base64 de _fontes/fontes.css e fotos de media/ como data URI.
Fotos que ainda não existem ficam como caminho relativo (o <img> tem onerror e há fundo de reserva)."""
import base64, os, re
