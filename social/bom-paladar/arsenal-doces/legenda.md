# Bom Paladar — "Cinco maneiras de acabar um jantar." (arsenal)
...
> Cinco maneiras de acabar um jantar. Qual vai ser a sua?
> As sobremesas mudam, por isso pergunte à mesa o que saiu hoje da cozinha.
>
> Jantar de segunda a sábado, das 19h às 22h30.
> Reservas pelo WhatsApp 918 958 233.
> R. do Comércio 367A, Almancil · bompaladar.pt
>
> #almancil #algarve #loule #sobremesas #docesdeautor #cozinhaportuguesa #jantaremalmancil
...
- Todas as fotos são reais, sem edição, e nenhuma foi publicada antes.
- Os textos descrevem só o que se vê na foto. Não pus nomes de sobremesas nem preços, porque não estão na carta que temos.
- Confirmar com a Simona que estas sobremesas continuam a sair. Se alguma já não existir, troca-se a foto em `build.py` (lista `DOCES`).
