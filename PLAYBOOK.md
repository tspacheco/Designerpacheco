...
- **Cartão de visita** (`marca/cartao/`): **em romeno** (mercado: Roménia), igual para todos os negócios. Propósito: *Web design · implementare sisteme AI*; telefone +351 967 117 357 (WhatsApp); frase do verso: «Nu promitem. **Arătăm.**» **PDF final pronto** (`cartao-impressao.pdf`). Contactos em `marca/dados.json`, partilhados com a página.
