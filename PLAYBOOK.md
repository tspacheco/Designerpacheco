...
- [ ] **Jasmim 2 – A Marisqueira (Manta Rota):** o site está em `jasmim2marisqueira.pt` (o `.com` não existe — NXDOMAIN a 26/09). Pedir o zip do site para o quadrado da página do QR ganhar a fonte e as cores dele (está em `neutro`); confirmar se entra no catálogo (secção 7) e em pachecost.com, que ainda não o tem (nem a Toda Chic).
