...
**Livres/planeadas:** Bevan (→ Sítio dos Presuntos) · Rye · Kufam · Gabarito 800/900 (→ CROAE Moita, com Atkinson Hyperlegible no corpo — legibilidade para serviço público).
...
- **Moita (Setúbal) — cliente institucional/ONG:** croae-moita (`sites/croae-moita/`) — Centro de Recolha Oficial de Animais Errantes, gerido pelo Gabinete Veterinário Municipal. Pesquisa em `research/croae-moita.md`; arquitetura em `sites/croae-moita/ARQUITETURA.md` (direção "As 40 boxes", secção de parcerias pedida no brief). Fotos do Instagram limpas em `media/croae-moita/`. Tel 212 806 816 / 962 049 674, gab.vetmun@cm-moita.pt. Morada, horário e lista de animais a confirmar. **Site por construir** — à espera de mais fotos.
...
- [ ] **CROAE Moita** — construir `sites/croae-moita/index.html` seguindo `ARQUITETURA.md` quando chegarem as fotos de animais/placares; limpar prints do Instagram (bordas + botões) com o método em `sites/croae-moita/ARQUITETURA.md` §5. Perguntar ao cliente: morada, horário, processo de adoção, parceiros com logótipo, se o site é da Câmara ou de voluntários.
