...
- **Iași (Roménia):** arina-copou (`sites/arina-copou/`) — **ARINA — Brutărie & Simigerie**, Complex Super Copou, Bd. Carol I 48 (a 1 min da UAIC); ficha Google "La Dolce Vita - SuperCopou" 5,0★/6 (relação entre os nomes a confirmar). Luni–Duminică 06:00–20:00. Trilingue RO/EN/FR, fontes embutidas em base64 (abre sem rede), JSON-LD `Bakery`, ANPC–SAL. Bree Serif + Nunito + Kaushan Script, assinatura "Rulou-ul se ridică la 6:00". **De confirmat:** telefone, WhatsApp, morada exata, firma/CUI, entregas; sem preços. Fotos por obter (8 slots em `media/`, LEIA-ME.txt).
...
- [ ] **Iași — semana 1 (28/09–04/10)** (`research/iasi.md`, secção 9): o Tomás está em Iași desde 25/09 (aulas na UAIC a partir de 28/09 — rua à tarde, 15h–18h). Confirmar no Maps e pedir num só chat as 5 primeiras demos RO/EN/FR (Pizza Nico, Berăria Veche, Bistro La Noi, Cafeneaua Piața Unirii, Fat Cat Coffee) · preencher demo + Place ID em `prospecao/qr/iasi.csv` e imprimir · centro só até 7/10 (Sf. Parascheva 8–15/10: bairros e follow-ups) · contabilista (VIES/autoliquidação, retenção) antes da 1.ª fatura · registo no IGI se ficar mais de 3 meses.
...
**Base: Iași (25/09/2026).** Relatório de zona em `research/iasi.md`: cidade em números (271.692 hab., ~50–60 mil estudantes, 2.976 estrangeiros na UMF — 1.107 franceses → demos RO/EN/FR), zonas por ordem (Nicolina/Tudor e bairros rendem mais do que o centro, onde metade dos independentes já tem site), Lista A com ~28 alvos sem site e fontes, lista "elevar" (Tiki Bistro, n.º 1 do TripAdvisor, com o site em manutenção), ângulo Sf. Parascheva (~300 mil pessoas de 8 a 15/10), preços locais (OLX 400–750 lei, agências desde ~500 € → manter 2.490 lei) e a primeira semana com datas.
